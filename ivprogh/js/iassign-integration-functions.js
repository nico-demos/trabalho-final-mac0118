...
// Apesar de nao ser obrigatório, sera muito util para capturar os parametros
...
function getEvaluation () {
  if (iLMparameters.iLM_PARAM_SendAnswer == 'false') {
    // A chamada do metodo abaixo e obrigatória!
